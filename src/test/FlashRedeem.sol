...
contract FlashRedeemTest is DSTest {
    address private DOODLES_NFTX_ADDR =
        0x2F131C4DAd4Be81683ABb966b4DE05a549144443;
    address private DOODLES_NFT_ADDR =
        0x8a90CAb2b38dba80c64b7734e58Ee1dB38B8992e;
    address private SENSEI_ADDR = 0x527B0642b3902C3Bc29ae13D8208b86dA007aa26;

    FlashRedeem flashRedeem;
    IERC721Upgradeable private DOODLES_NFT =
        IERC721Upgradeable(DOODLES_NFT_ADDR);
    ...
    function testFlashRedeem() public {
        ...
        flashRedeem.flashBorrow{value: 7.5 ether}(DOODLES_NFTX_ADDR, amount);
